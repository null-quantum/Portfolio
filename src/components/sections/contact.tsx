...
export function Contact() {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast({
        title: "Message sent! 🎉",
        description: json.message ?? "I'll get back to you soon.",
      })
  ...
  return (
    <section id="contact" className="relative py-24 sm:py-28 border-t border-border/40 bg-muted/20">
            ...
            <Card className="p-6 sm:p-8">
              <form onSubmit={onSubmit} className="space-y-4">
                ...
                <p className="text-center text-xs text-muted-foreground font-mono">
                  POST /api/contact → persists to Postgres via Prisma
                </p>
              </form>
            </Card>
          </motion.div>
